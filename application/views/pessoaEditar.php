...
<html>
    ...
    <?php
    if (!is_null($pessoa[0]->cpf) && is_null($pessoa[0]->cnpj)) {
        echo 'checked';
    } else {
        echo 'disabled';
    }
    ?> name="tpPessoa"/>Física

    <input type="radio" required value="Juridica"
    <?php
    if (!is_null($pessoa[0]->cnpj) && is_null($pessoa[0]->cpf)) {
        echo 'checked';
    } else {
        echo 'disabled';
    }
