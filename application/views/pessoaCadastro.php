                ...
                <?php foreach ($pessoas as $pes): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?php echo base_url() . 'pessoa/excluir/' . $pes->idPessoa; ?>" >Deletar</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
