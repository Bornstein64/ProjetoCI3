...
<html>
    ...
    <body>
        ...
        <?php echo form_open('usuarioControl/inserir'); ?>
        ...
        <br><br>
        <input type="radio" required value="admin" name="perfilAcesso"/>Administrador
            ...
            <tbody>
                <?php foreach ($users as $user): ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url() . 'usuarioControl/editar/' . $user->idusuario; ?>" >Editar</a> | 
                            <a href="<?php echo base_url() . 'usuarioControl/excluir/' . $user->idusuario; ?>" >Deletar</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
